...
function collision.boundingBox(x1,y1,w1,h1,vx1,vy1,x2,y2,w2,h2,vx2,vy2)
	if x1 and y1 and w1 and h1 and vx1 and vy1 and x2 and y2 and w2 and h2 and vx2 and vy2 then
		...
		debug.log("[ERROR] Incorrect call to function 'collision.boundingBox(x1,y1,w1,h1,vx1,vy1,x2,y2,w2,h2,vx2,vy2)'")
		return 0, 0, 0, 0
	end
end
